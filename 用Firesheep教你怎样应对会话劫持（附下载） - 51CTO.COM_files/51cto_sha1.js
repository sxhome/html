...
$(function(){
	...
	var tt = t.substr(1, 10);
	var url = window.location.host;
	var type = url.split('.');
	var key = '51CTO_GAOZHAO';
	var signature = hex_sha1(key+tt);
	$.ajax({
		url: 'http://gaozhao.51cto.com/api/site/job-list',
		data: {time:tt,type:'cms_'+type[0], signature:signature, page_size: '5'},
		type: 'GET',
		async: false,
		dataType: 'JSONP',
		jsonp:'callback', 
