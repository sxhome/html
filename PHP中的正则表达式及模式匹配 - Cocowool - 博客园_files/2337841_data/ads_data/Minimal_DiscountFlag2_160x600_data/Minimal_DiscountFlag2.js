 ...
 * @param {!ShapeDimensions_} ShapeDimensions_ Object with computed canvas
 *    data.
 */
Product.prototype.drawArrow = function(ShapeDimensions_) {
  ...
  var textPosition = {
    x: arrowPointerWidth * 3,
    y: ShapeDimensions_.halfHeight
  };

  var offsetWidth = shapeWidth - arrowPointerWidth;

  if (this.context) {
    this.context.moveTo(arrowPointerWidth, ShapeDimensions_.halfHeight);
    this.context.lineTo(0, 0);
    this.context.lineTo(shapeWidth, 0);
    this.context.lineTo(shapeWidth, shapeHeight);
    this.context.lineTo(0, shapeHeight);
    this.context.lineTo(arrowPointerWidth, ShapeDimensions_.halfHeight);
